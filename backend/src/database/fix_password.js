...
async function updatePasswords() {
    ...
    const [result] = await pool.query(
        `UPDATE users SET password = ? WHERE email IN ('passenger@test.com','passenger@gmail.com','driver@test.com','driver1@test.com','driver1@gmail.com','driver@gmail.com','driver2@test.com','driver3@test.com')`,
        [correctHash]
    );
    ...
    // Verify
    const [rows] = await pool.query("SELECT email FROM users WHERE email LIKE '%@test.com' OR email LIKE '%@gmail.com'");
